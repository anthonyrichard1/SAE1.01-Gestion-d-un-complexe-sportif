...
/**
 * \brief Cette fonction permet de rechercher la position et la présence d'une activité dans les tableaux. À partir du tableau des activités, la fonction transmet si elle a trouvé ou non l'activité et renvoie sa position dans le tableau (s'il est trouvé).
 ...
 * \return int Un entier représentant la position de l'activité dans le tableau.
 */
