 ...
 * \date 07/11/2022
 * \brief Dans ce fichier sont répertoriées toutes les fonctions qui gère les activités du complexe.
 */
...
/**
 * \brief Cette fonction permet à un adhérent de réserver des activites. Elle débute par la saisie au clavier de l'identifiant de l'adhérent à ajouter. Ensuite, elle demande le numéro de l'activité à résever autant de choix que possible (donc 3 fois). A chaque saisie au clavier, l'utilisateur a la possibilité d'annuler l'opération en tapant -1.
